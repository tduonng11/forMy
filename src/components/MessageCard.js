...
const messages = [
    ...
    "Đối với tớ cậu ngày nào cũng đặc biệt và mong cho các cô gái ngoài kia ai cũng xứng đáng có một người khiến mình cảm thấy đặc biệt.Chúc cậu luôn vui vẻ, xinh đẹp, được nhiều yêu thương, hạnh phúc.Và tớ mong người khiến cậu hạnh phúc là tớ",
