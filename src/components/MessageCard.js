...
const messages = [
    ...
    "Nhưng đó không phải là cố ý đụng chạm mà đóđó là cách tớ thể hiện cảm xúc với người tớ thương.",
    ...
    "TTớ muốn kể cho cậu nghe một ngày của tớ như thế nào và cũng muốn hỏi cậu như vậy.",
    ...
    "Nhưng hôm nay là một ngày rất đặc biệt nên tớ muốn nói hết ra những điều tớ nghĩnghĩ...",
